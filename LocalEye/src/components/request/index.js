          ...
          <Wrapper style={{ justifyContent: 'space-between', paddingLeft: width(1), height: height(15), width: width(20) }}>
            <Wrapper flexDirectionRow>
              ...
              <Buttons.Bordered
                ...
                tintColor={buttcolor}
                buttonStyle={[{ height: height(4), width: width(30), left: width(5),backgroundColor:'#7CE1161C',borderColor:'#7CE116',color:'black' },activbutstyle]}
...
<Wrapper flexDirectionRow >
          <Buttons.Bordered
            text={'Cancel'}
            tintColor={'#EF0909'}
            buttonStyle={{ height: height(5), width: width(35), borderColor: '#EF0909', color: 'black' }}
          />  
            <Buttons.Colored
          text={'Accept'}
          buttonColor={['#B84B62', '#B84B62', '#711A2D']}
          buttonStyle={{ height: height(5), width: width(35) ,right:width(1)}}
