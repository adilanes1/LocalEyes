...
const Colored = ({
    ...
    left, customIconLeft, iconNameLeft, iconTypeLeft, iconSizeLeft,customIconRight,
                ...
                <View style={{}}>
                    {
                        right ?
                            ...
                            customIconRight ?
                            <Wrapper style={{ alignItems: 'center', marginLeft: sizes.marginHorizontal/2 }}>
                                <Icons.Custom icon={customIconRight} size={iconSizeRight ? iconSizeRight : sizes.icons.medium} color={iconColorRight} containerStyle={iconStyleRight} />
                            </Wrapper>
                            :
                            iconNameRight ?
    ...
    return (
        <TouchableOpacity
            ...
            <Wrapper style={[appStyles.inputContainerColored, {
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: sizes.marginHorizontal }}>
                    <TouchableOpacity onPress={decrementCounter}>
                    <Wrapper isGradient gradiantColors={['#B84B62','#B84B62','#711A2D']} style={{height:height(4),width:width(8),borderRadius:width(7)}} alignItemsCenter justifyContentCenter>
                        <Icon name="minus" type="font-awesome" size={iconSizeRight || sizes.icons.medium} color={iconColorRight || colors.appTextColor5} iconStyle={iconStyleRight} />
                        </Wrapper>
                    </TouchableOpacity>
                    <Text style={{ marginHorizontal: sizes.marginHorizontal / 2 }}>{counter}</Text>
                    <TouchableOpacity onPress={incrementCounter}>
                        <Wrapper isGradient gradiantColors={['#B84B62','#B84B62','#711A2D']} style={{height:height(4),width:width(8),borderRadius:width(7)}} alignItemsCenter justifyContentCenter>
                        <Icon name="plus" type="font-awesome" size={iconSizeRight || sizes.icons.medium} color={iconColorRight || colors.appTextColor5} iconStyle={iconStyleRight} />
...
const DropdownInput = ({
    items, defaultValue, containerStyle, title, titleStyle, onChangeItem, placeholder, placeholderStyle, error
}) => {
    ...
    return (
        <View style={[{ marginHorizontal: sizes.marginHorizontal }, containerStyle]}>
            {
                title ?
                    <Wrapper style={{ marginHorizontal: 0 }}>
                        <Text isInputTitle style={[{}, titleStyle]}>{title}</Text>
            ...
            <DropDownPicker
                ...
                placeholder={placeholder}
                placeholderStyle={placeholderStyle || { color: colors.appTextColor4 }}
                style={{
                    borderColor: colors.appBgColor3,
                    borderWidth: 1,
                    borderRadius: sizes.inputRadius,
...
export { Colored, Bordered, Underlined, SearchBar ,PhoneNumberInput,DropdownInput,Removedin}
