      ...
      <ScrollViews.KeyboardAvoiding>
        ...
        <Wrapper style={{ paddingTop: 35 }} alignItemsCenter>
          <Buttons.Colored
            ...
            iconStyleRight={{ height: height(6), width: width(11.5), backgroundColor: 'white', justifyContent: 'center', borderRadius: width(8), alignItems: 'center', left: width(29) }}
        ...
        <Wrapper alignItemsCenter style={{ paddingTop:height(7) }}>
          <TouchableOpacity onPress={ ()=>{navigation.navigate(routes.localsignin)}}>
              ...
              <View style={modalStyles.modalView}>
                ...
                <Buttons.Colored
                  ...
                  onPress={() => {
                    ...
                    navigation.navigate(routes.localProfile);
                  }}
                  buttonStyle={{ height: height(7), width: width(90) }}
                />
              </View>
